...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var popups = function popups() {
    ...
    bindModal('.project__card', '.popup-content__project', '.popup-close');
    bindModal('.politics-box', '.popup-politics', '.popup-close');
  }; // ==========
  // ИНПУТ ВЫБОРА (SELECT)


  var butSel = document.querySelector('#button');
  ...
  function setSelectTitle(e) {
    var labelElement = document.querySelector("label[for=\"".concat(e.target.id, "\"]")).innerText;
  ...
  var inputPhone1 = document.querySelector('#input-phone1');
  var bannerForm = document.querySelector('#form2');
  var inputName2 = document.querySelector('#input-name2');
  var inputPhone2 = document.querySelector('#input-phone2');
  var footerForm = document.querySelector('#form3');
  var inputName3 = document.querySelector('#input-name3');
  var inputPhone3 = document.querySelector('#input-phone3'); // const secondForm = document.querySelector('#form2');
  ...
  bannerForm.addEventListener('submit', function (e) {
    ...
    checkLength(inputPhone2, 16, 20); // checkEmail(inputMail);
    // checkPasswordsMatch(inputPassword1, inputPassword2);
  });
  footerForm.addEventListener('submit', function (e) {
    ...
    checkLength(inputPhone3, 16, 20); // checkEmail(inputMail);
    // checkPasswordsMatch(inputPassword1, inputPassword2);
  }); // Бургер меню
  ...
  var aboutusAnchor = document.querySelector('.aboutus-anchor');
  var projectsAnchor = document.querySelector('.projects-anchor');
  var reviewsAnchor = document.querySelector('.reviews-anchor');
  var stepsAnchor = document.querySelector('.steps-anchor');
  var contactsAnchor = document.querySelector('.contacts-anchor');
  ...
  var aboutusBtn = document.querySelector('.aboutus-btn');
  var projectsBtn = document.querySelector('.projects-btn');
  var reviewsBtn = document.querySelector('.reviews-btn');
  ...
  var buildingTypesBtns = Array.prototype.slice.call(document.querySelectorAll('.building-type'));
